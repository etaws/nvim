...
cmake.setup({
    ...
    configure_args = { "-D", "CMAKE_EXPORT_COMPILE_COMMANDS=1", "-D", "CMAKE_C_COMPILER=/Users/xzhou/tools/llvm-14/bin/clang" }, -- Default arguments that will be always passed at cmake configure step. By default tells cmake to generate `compile_commands.json`.
